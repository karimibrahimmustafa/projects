...
public class Copy_2_of_DrawSample4 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Copy_2_of_DrawSample4 window = new Copy_2_of_DrawSample4();
		...
		panel.add(noColor);
				...
				panel.add(button_2);
						...
						panel.add(button_8);
								...
								panel.add(pick2);
								pick2.addMouseListener(new MouseAdapter() {
									@Override
									public void mouseClicked(MouseEvent e) {
								...
								panel.add(pick3);
								pick3.addMouseListener(new MouseAdapter() {
									@Override
									public void mouseClicked(MouseEvent e) {
								...
								panel.add(pick4);
								pick4.addMouseListener(new MouseAdapter() {
									@Override
									public void mouseClicked(MouseEvent e) {
										 selectedColor.setBackground(pick4.getBackground()); 
